    ...
    try:
        for record in event["Records"]:
            ...
            agent_response = bedrock_agent_runtime.invoke_agent(
                ...
                input={"text": f"Generate a multiple choice quiz for {category} in OWASP"}
            )

            output = agent_response.get("completion") or agent_response.get("output") or agent_response.get("content")
